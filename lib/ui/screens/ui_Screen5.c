...
ui_BackLabel05 = lv_label_create(ui_Header5);
lv_obj_set_width( ui_BackLabel05, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_BackLabel05, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_BackLabel05, 0 );
lv_obj_set_y( ui_BackLabel05, -20 );
lv_label_set_text(ui_BackLabel05,"<");
lv_obj_set_style_text_color(ui_BackLabel05, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_BackLabel05, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_BackLabel05, &lv_font_montserrat_34, LV_PART_MAIN| LV_STATE_DEFAULT);
